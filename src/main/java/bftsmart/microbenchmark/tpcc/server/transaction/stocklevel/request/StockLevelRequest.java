package bftsmart.microbenchmark.tpcc.server.transaction.stocklevel.request;
...
public class StockLevelRequest implements TransactionRequest {
    ...
    public StockLevelRequest withCommandId(String commandId) {
    ...
    public StockLevelRequest withTransactionType(int transactionType) {
    ...
    public StockLevelRequest withWarehouseId(int warehouseId) {
    ...
    public StockLevelRequest withDistrictId(int districtId) {
    ...
    public StockLevelRequest withThreshold(int threshold) {
