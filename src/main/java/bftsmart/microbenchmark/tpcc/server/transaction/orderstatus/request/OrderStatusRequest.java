package bftsmart.microbenchmark.tpcc.server.transaction.orderstatus.request;
...
public class OrderStatusRequest implements TransactionRequest {
    ...
    public OrderStatusRequest withCommandId(String commandId) {
    ...
    public OrderStatusRequest withTransactionType(int transactionType) {
    ...
    public OrderStatusRequest withWarehouseId(int warehouseId) {
    ...
    public OrderStatusRequest withDistrictId(int districtId) {
    ...
    public OrderStatusRequest withCustomerId(int customerId) {
    ...
    public OrderStatusRequest withCustomerByName(boolean customerByName) {
    ...
    public OrderStatusRequest withCustomerLastName(String customerLastName) {
