...
public class NewOrderLineOutput implements KryoSerializable {
    ...
    public NewOrderLineOutput withSupplierWarehouseId(int supplierWarehouseId) {
    ...
    public NewOrderLineOutput withItemId(int itemId) {
        setItemId(itemId);
        return this;
    }
    ...
    public NewOrderLineOutput withItemName(String itemName) {
    ...
    public NewOrderLineOutput withOrderQuantities(int orderQuantities) {
    ...
    public NewOrderLineOutput withStockQuantities(int stockQuantities) {
    ...
    public NewOrderLineOutput withBrandGeneric(char brandGeneric) {
    ...
    public NewOrderLineOutput withItemPrice(double itemPrice) {
        setItemPrice(itemPrice);
        return this;
    }

    public NewOrderLineOutput withItemPrice(BigDecimal itemPrice) {
    ...
    public NewOrderLineOutput withOrderLineAmounts(double orderLineAmounts) {
        setOrderLineAmounts(orderLineAmounts);
        return this;
    }

    public NewOrderLineOutput withOrderLineAmounts(BigDecimal orderLineAmounts) {
